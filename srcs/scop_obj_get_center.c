...
/*   Updated: 2017/03/14 15:05:26 by cledant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		scop_obj_get_center(t_env *env)
{
	...
	if (env->obj.nb_pos > 0)
	{
		env->obj.center.x = -env->obj.center.x / (GLfloat)(env->obj.nb_pos);
		env->obj.center.y = -env->obj.center.y / (GLfloat)(env->obj.nb_pos);
		env->obj.center.z = -env->obj.center.z / (GLfloat)(env->obj.nb_pos);
	}
	return (1);
}
